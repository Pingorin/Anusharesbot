...
async def start(client, message):
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        btn = [
            [
                InlineKeyboardButton(
                    '♦️ Join Updates Channel ♦️', url="https://t.me/anurinomoviez"
                )
            ]
        ]
        ...
        await client.send_message(
            ...
            text="**Please Join ♦ ️Updates channel ♦️then click on 🔄 Try again button you will get your movie/series...\n\nIf you not join update channel you will not get your movies/series\n\nकृपया इस ♦️ Updates channel ♦️ को Join करें 🔄 Try again बटन पर क्लिक करें आपको Movie मिल जाएगी |...**",
